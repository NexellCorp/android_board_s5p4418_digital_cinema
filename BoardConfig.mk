TARGET_BOARD_INFO_FILE := device/nexell/s5p4418_digital_cinema/board-info.txt


TARGET_BOARD_PLATFORM 		 := slsiap
TARGET_BOOTLOADER_BOARD_NAME := s5p4418_digital_cinema
...
# recovery
TARGET_RECOVERY_FSTAB := device/nexell/s5p4418_digital_cinema/recovery.fstab

#TARGET_RELEASETOOLS_EXTENSIONS := device/nexell/s5p4418_digital_cinema
#TARGET_RECOVERY_UPDATER_LIBS += librecovery_updater_s5p4418_digital_cinema
#TARGET_RECOVERY_UI_LIB := librecovery_ui_s5p4418_digital_cinema
...
# certificate
#PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/nexell/security/s5p4418_digital_cinema/release
...
# sepolicy
BOARD_SEPOLICY_DIRS := \
	device/nexell/s5p4418_digital_cinema/sepolicy
