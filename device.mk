...
################################################################################
#PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/boot/2ndboot.bin:2ndbootloader
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/init.s5p4418_digital_cinema.rc:root/init.s5p4418_digital_cinema.rc \
	device/nexell/s5p4418_digital_cinema/init.s5p4418_digital_cinema.usb.rc:root/init.s5p4418_digital_cinema.usb.rc \
...
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/busybox:busybox

################################################################################
# key
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/keypad_s5p4418_digital_cinema.kl:system/usr/keylayout/keypad_s5p4418_digital_cinema.kl \
	device/nexell/s5p4418_digital_cinema/keypad_s5p4418_digital_cinema.kcm:system/usr/keychars/keypad_s5p4418_digital_cinema.kcm

################################################################################
# touch
################################################################################
PRODUCT_COPY_FILES += \
    device/nexell/s5p4418_digital_cinema/tsc2007.idc:system/usr/idc/tsc2007.idc
...
################################################################################
#PRODUCT_COPY_FILES += \
	#device/nexell/s5p4418_digital_cinema/vold.fstab:system/etc/vold.fstab
...
# mixer paths
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/audio/tiny_hw.s5p4418_digital_cinema.xml:system/etc/tiny_hw.s5p4418_digital_cinema.xml
# audio policy configuration
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/audio/audio_policy.conf:system/etc/audio_policy.conf

################################################################################
################################################################################
PRODUCT_COPY_FILES += \
	device/nexell/s5p4418_digital_cinema/media_codecs.xml:system/etc/media_codecs.xml \
	device/nexell/s5p4418_digital_cinema/media_profiles.xml:system/etc/media_profiles.xml
...
################################################################################
#PRODUCT_COPY_FILES += \
  #device/nexell/s5p4418_digital_cinema/tablet_core_hardware.xml:system/etc/permissions/tablet_core_hardware.xml \
...
DEVICE_PACKAGE_OVERLAYS := \
	device/nexell/s5p4418_digital_cinema/overlay
...
PRODUCT_COPY_FILES += \
	...
	linux/platform/s5p4418/apps/vd_cinema/bin/nx_dump_logcat:system/bin/nx_dump_logcat \
